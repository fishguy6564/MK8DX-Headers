...
{
    class ScreenMgr;
    class Screen : public sead::IDisposer, public SeadGameAllocator, public SeadGameDeallocator
    {
        public:
            ...
            virtual const char* getLayoutName_(void)const { return nullptr; }; //0x68!
